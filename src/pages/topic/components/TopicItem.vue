  ...
  <div class="dynamic-item" @click.stop="goDynamic">
    <div class="user-overview">
      ...
      <div class="user-name clearfix">
        ...
        <!-- <img v-if="itemData.is_manager" :src="$assetsFullPath + 'image/manager.png'" class="user-tag fl" />
        <img v-if="itemData.is_owner" :src="$assetsFullPath + 'image/circle_owner.png'" class="user-tag fl" />
        <img v-if="itemData.is_settop" :src="$assetsFullPath + 'image/settop.png'" class="user-tag fl" /> -->
      </div>
      <div class="publish-time-and-circle">{{itemData.time}}<i class="iconfont icon-dian"></i><i class="iconfont" :class="dysignClass"></i><span class="from-circle" v-if="itemData.circle_name">发布于<span @click.stop="goCircle" class="from-circle-text">{{itemData.circle_name}}</span></span></div>
    </div>
